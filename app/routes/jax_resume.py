...
def temas(tema):
    ...
    return render_template("lista_posts.html", posts=posts, tema=tema, year=current_year, current_user=usuario)
...
def post(post_id):
    ...
    return render_template("post_completo.html", post=resumo, year=current_year, current_user=usuario)
